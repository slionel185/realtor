...
export const Pricing = () => {
    return (
        <Container id="pricing" className='grid lg:grid-cols-3 gap-8'>
            <div id='basic' className='p-6 flex flex-col items-center rounded shadow-md gap-2'>
            ...
            <div id='premium' className='p-6 flex flex-col items-center rounded shadow-md gap-2'>
